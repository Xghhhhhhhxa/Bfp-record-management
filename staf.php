...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <a href="#record-management"><i class="icon">&#128202;</i> Record Management</a>
      ...
      <center>  <h2>Welcome to the BFP Record Management System</h2></center>
        ...
        <div class="folder-grid">
            ...
            <div id="record-management" class="folder-item">
                ...
                <p>Manage and view records of establishments registered with the Bureau of Fire Protection (BFP).</p>
                <a href="#record-management" class="btn btn-primary btn-sm">View Records</a>
            </div>
